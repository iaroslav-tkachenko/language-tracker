  ...
  return (
    <ul className="flex flex-wrap gap-1.5">
      {activities.map((activity) => (
        <li
          key={activity.id}
          className="inline-flex min-h-8 items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 py-0.5 pr-0.5 pl-2.5 text-xs font-medium text-slate-700"
        >
          <ActivityIcon
