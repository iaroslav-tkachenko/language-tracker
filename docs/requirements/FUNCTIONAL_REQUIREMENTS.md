...
| `FR-ENTRY-015` | An entry card shall show duration, activity, and language-board name with edit and delete controls. | Controls appear on pointer hover and keyboard focus on desktop; both icons remain persistently visible on mobile/touch layouts.                      |
