...
| `FR-UI-011` | During Phases 1 and 2, the visible `Vocabulary` tracker tab shall be disabled and labelled `Coming soon`.                                          | The control communicates its unavailable state and cannot navigate to incomplete behavior; Phase 3 replaces it with the active tab.   |
