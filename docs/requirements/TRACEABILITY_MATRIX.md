...
| Reference model governance       | `FR-CEFR-010`, `FR-STAT-015`, `NFR-TRUST-004`                            | Approved vocabulary midpoints remain immutable; no ideal-allocation comparison appears before its values and methodology are approved. |
